We use K means clustering for our analysis given its ease to compute clusters and its efficiency of handling large number of cases better than hierarchical clustering.
